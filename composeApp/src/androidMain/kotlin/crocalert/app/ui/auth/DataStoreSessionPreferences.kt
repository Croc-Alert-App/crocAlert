...
private const val DATASTORE_TIMEOUT_MS = 3_000L
...
class DataStoreSessionPreferences(private val context: Context) : SessionPreferences {
    ...
    override suspend fun getSavedEmail(): String? =
        withTimeoutOrNull(DATASTORE_TIMEOUT_MS) {
            context.sessionStore.data
                .catch { emit(emptyPreferences()) }
                .map { it[savedEmailKey] }
                .first()
        }
